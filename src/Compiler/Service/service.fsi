...
module internal CompileHelpers =
    val mkCompilationDiagnosticsHandlers: unit -> ResizeArray<FSharpDiagnostic> * DiagnosticsLogger * DiagnosticsLoggerProvider
    val tryCompile: DiagnosticsLogger -> (Exiter -> unit) -> int 
